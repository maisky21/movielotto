...
- **Security & Compatibility:**
    - **Disney+ Deep Link:** Updated to `https://www.disneyplus.com/browse/search` for universal device compatibility and to prevent 404 errors on Mac/logged-out browsers.
